...
@section('content')
    <section id="item" style="background-color: rgb(255, 255, 255);" class="item my-3 " data-filter="item">
        <div class="container p-4">
            <h3 style="font-weight:bold; color: #ffae00;">Selamat Datang !</h3>
            <a href="#" data-bs-toggle="modal" data-bs-target="#createcampaign" style="text-decoration: none;">
                <div class="hvr-grow shadow mt-3 d-flex align-items-center"
                    style="height: 250px; border-radius:25px; background-image: linear-gradient(to right, #ffae00, rgba(231, 231, 231, 0.5)), url('https://images.unsplash.com/photo-1516570161787-2fd917215a3d?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1170&q=80'); background-size: cover;">
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-footer">
                            ...
                            <button type="button" class="btn" data-bs-toggle="modal" data-bs-target="#create"
                                style="background-color: #ffae00; color:#fff">Selanjutnya</button>
                        </div>
                    </div>
                @else
                    <div class="modal-content">
                        ...
                        <div class="modal-body text-center">
                            <a class="btn" style="border-radius: 50px; background-color:#ffae00; color:#ffffff"
                                href="/login">Login</a>
                        </div>
                    </div>
                @endauth
                                ...
                                <form method="post" action="/buat-campaign"enctype="multipart/form-data">
                                    ...
                                    <div class="text-center mt-3">
                                        <button type="submit" class="btn"
                                            style="background-color: #ffae00; color:#fff; border-radius:50px; width:100%">Kirim</button>
                                    </div>
                                </form>
                            </div>
                        </div>
    ...
    <section data-filter="item" class="item splide my-3" aria-labelledby="carousel-heading" id="item"
        ...
        <div class="container item py-4 px-2">
            <div class="col" style="width: 75%;">
                <h5 class="p-3" style="font-weight:bold; color: #ffae00;">Penggalangan Dana Mendesak</h5>
            </div>
    ...
    <section data-filter="item" id="item" style="background-color: rgb(255, 255, 255);" class="item my-3 py-3">
        <div class="container p-4">
            <div class="col" style="width: 75%;">
                <h5 class="p-2" style="font-weight:bold; color: #ffae00;">Artikel Terbaru</h5>
            </div>
            ...
            <div class="col-12 text-center mt-5">
                <a href="/blog">
                    <div class="btn me-1 mb-1" style="background-color: #ffae00; color:#fff">
                        Artikel Lainnya</div>
                </a>
            </div>
        </div>
