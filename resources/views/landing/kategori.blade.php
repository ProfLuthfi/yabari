...
@section('content')
    <section id="category" style=" background-color: rgb(255, 255, 255);">
        ...
        <div class="container text-center">
            <h5 class="p-4 mt-2" style="font-weight:bold; color: #ffae00;">Kategori @if ($kat == 1)
                    Pendidikan
                @endif
                @if ($kat == 2)
                    Sosial
            ...
            <button class="btn" style="border-radius: 50px; background-color:#ffae00"><a href="/"
            ...
            <div class="row justify-content-center p-4">
                @foreach ($campaign as $item)
                    <a href="/campaign/{{ $item->slug_campaign }}" class="item card hvr-grow m-2"
                        ...
                        style="width: 18rem; padding: 0px;  border-color: #ffae00; text-decoration: none; color:black">
                        ...
                        <div class="card-body">
                            ...
                            <div class="progress" style="height: 10px;">
                                <div class="progress-bar" role="progressbar" aria-label="Basic example" aria-valuenow="75"
                                    ...
                                    style="background-color:#ffae00; width:{{ ($item->dana_terkumpul / $item->target_campaign) * 100 }}%">
                                </div>
                            </div>
