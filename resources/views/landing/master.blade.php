...
<head>
    ...
    <title>Yabari Peduli</title>
    <link rel="shortcut icon" href="/assets/images/logo/yb.ico" type="image/x-icon">
    @yield('style')
...
<body style="font-family: poppins; background-color:#F7F7F7; height:100%" id="body">
    <section class="shadow-sm" id="searchbar">
        <nav class="navbar p-3 mobile" style="background-color:#ffae00;">
        ...
        <nav class="navbar dekstop" style="background-color:#ffffff;">
            <div class="container py-2 px-4">
                <a href="/" class="navbar-brand" style="color: #ffae00;">
                    <img style="width: 35px; height: 100%" src="/assets/images/logo/logo.png" alt="Logo">
                </a>
                @auth
                    @if (Auth::user()->role == 0)
                        <a href="/admin" class="nav-item px-2" style="color: #ffae00;text-decoration: none;">Dashboard</a>
                        <div class="dropdown">
                            <button style="color:#ffae00" class="btn dropdown-toggle" type="button"
                    ...
                    @else
                        <a href="/donasi-saya" class="nav-item px-2" style="color: #ffae00;text-decoration: none;">Donasi
                            Saya</a>
                        <a href="/campaign-saya" class="nav-item px-2"
                            style="color: #ffae00;text-decoration: none;">Campaign
                            Saya</a>
                        <div class="dropdown">
                            <button style="color:#ffae00" class="btn dropdown-toggle" type="button"
                                data-bs-toggle="dropdown" aria-expanded="false">
                    ...
                    @endif
                @else
                    <a href="/#campaign" class="nav-item px-2" style="color: #ffae00;text-decoration: none;">Campaign</a>
                    <a href="/blog" class="nav-item px-2" style="color: #ffae00;text-decoration: none;">Blog</a>
                    <a href="/login" class="nav-item px-2" style="color: #ffae00;text-decoration: none;">Login</a>
                @endauth
    ...
    <nav class="fixed-bottom mb-4 mobile">
        <div class="container-fluid" style="width: 100%;">
            <div class="container d-flex align-items-center justify-content-center shadow"
                style="background-image: linear-gradient(to bottom right, #ffae00, #c79b3c); height:75px; border-radius:750px; width: 100%; border: solid #ffffff 5px; margin: 0px; padding: 0px;">
                <div class="row">
                    <div class="col mx-1">
    ...
    <div id="category" class="d-none" style="background-color: rgb(255, 255, 255);">
        <div class="container text-center">
            <h5 class="p-4 mt-2" style="font-weight:bold; color: #ffae00;">Hasil Pencarian</h5>
            <button class="btn" id="back" style="border-radius: 50px; background-color:#ffae00"><a
    ...
    <footer class="py-3" style="background-color: rgb(255, 255, 255);">
        <p class="text-center text-muted mt-3">&copy; <?php echo date('Y'); ?> Yabari Peduli</p>
    </footer>
