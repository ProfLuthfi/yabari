...
<head>
    ...
    <title>Welcome to Backlink</title>
...
<body style="background-color: #e9ecef;">
    ...
    <div class="preheader"
        ...
        Selamat Datang, {{ $body_email['name'] }}. Terima kasih telah mendaftar di {{ $body_email['title'] }}. Berikut
                ...
                <table border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width: 600px;">
                    ...
                    <tr>
                        <td bgcolor="#ffffff" align="left"
                            ...
                            <h1 style="margin: 0 0 12px; font-size: 32px; font-weight: 400; line-height: 48px;">Selamat
                                Datang, {{ $body_email['name'] }}!</h1>
                            <p style="margin: 0;">Terima kasih telah mendaftar di {{ $body_email['title'] }}. Berikut
                                detail registrasi Anda:</p>
                        </td>
                    </tr>
                    <!-- end copy -->
                    ...
                    <tr>
                        <td bgcolor="#ffffff" align="left"
                            ...
                            <br></br>
                            <p style="margin: 0;">Harap verifikasi email Anda dengan link di bawah ini:</p>
                        </td>
                    </tr>
                    <!-- end body -->
                            ...
                            <table border="0" cellpadding="0" cellspacing="0">
                                <tr>
                                    <td align="center" bgcolor="#1a82e2" style="border-radius: 6px;">
                                        {{-- <a href="{{ route('verifikasi-akun', $body_email['token']) }}" target="_blank"
